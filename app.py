...
def upload_invoice():
    ...
    if file:
        try:
            ...
            print("--- TEXTE COMPLET EXTRAIT DU PDF (Backend V10.1 - Fix NameError) ---")
            ...
            data_line_after_release_re = re.compile( # Cette définition doit être correcte
            ...
            while i < len(lines):
                ...
                if match_release_data:
                    ...
                    if current_name_str:
                        ...
                        print(f"DEBUG_PARSING (V10.1): Cas 1 (QPT sur ligne Release) mais nom manquant. Ligne: '{line_stripped}'")
                    ...
                    if (i + 1) < len(lines):
                        ...
                        match_data_next_line = data_line_after_release_re.match(next_line_stripped) # Utilisation de la variable
                ...
                if quantity_val is not None and unit_price_val is not None: # Pas besoin de product_name_candidate ici
                    final_name = current_name_str # current_name_str a été défini si Q et P l'ont été
                    ...
                    if final_name:
                        ...
                        print(f"  ==> PRODUIT AJOUTÉ (V10.1): {final_name} (Qté: {quantity_val}, Prix: ${unit_price_val}, Date: {release_date_val})")
                         ...
                         print(f"DEBUG_PARSING (V10.1): Nom produit vide APRES nettoyage. Ligne approx: '{lines[i].strip()}'")
                    product_name_buffer = [] 
